...
main.seeds = [
  'seed.mainnet.b-pay.net', // BitPay seed
  'seed.ob1.io', // OB1 seed
  'seed.blockchain.info', // blockchain.info seed
  'bitcoin.bloqseeds.net', // bloq.com seed
...
testnet.seeds = [
  ...
  'bitcoin-testnet.bloqseeds.net' // bloq.com seed
];

testnet.magic = 0x0074656e;

testnet.port = 18555;

testnet.checkpointMap = {
  10001: 'd8bf894f28c2104e1443450070c77a4bb82119e844125feb2a0a7cfb00000000'
};
...
testnet.block = {
  bip34height: 10001,
  bip34hash: 'd8bf894f28c2104e1443450070c77a4bb82119e844125feb2a0a7cfb00000000',
  bip65height: 10001,
  bip65hash: 'd8bf894f28c2104e1443450070c77a4bb82119e844125feb2a0a7cfb00000000',
  bip66height: 10001,
  bip66hash: 'd8bf894f28c2104e1443450070c77a4bb82119e844125feb2a0a7cfb00000000',
  pruneAfterHeight: 1000,
  keepBlocks: 10000,
  maxTipAge: 24 * 60 * 60,
  slowHeight: 950000
...
testnet.deployments = {
  ...
  testdummy: {
    ...
    bit: 28,
    startTime: 1496275200, // June 1st, 2017
    timeout: 1510704000, // November 15st, 2017
    threshold: -1,
    window: -1,
    required: false,
    force: true
